...
export const Product = ({ product }) => {
  ...
  return (
    <div className="p-1 xs:mb-2 border-solid border-[1px] md:border-transparent xs:border-gray-100 lg:mb-0 flex items-center shadow-md group shadow-black/10 hover:shadow-gray-400 transition duration-300 cursor-pointer rounded-md justify-center flex-col">
