          ...
          {products && (
            <div className="flex items-center justify-center flex-col w-11/12 mx-auto mt-3">
              ...
              <button
                ...
                } p-3 flex items-center justify-center bg-rose-500 w-full text-white rounded-md mt-2 cursor-pointer font-normal text-sm hover:bg-rose-600 transition duration-300`}
              >
                Reset
